...
export default function Header() {
  ...
  return (
    <header className="glass-strong sticky top-0 z-50 px-4 py-3 md:py-4">
      <div className="mx-auto flex max-w-6xl items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
          <Link
            href="/"
            className="text-text-secondary hover:text-accent-gold transition-colors duration-300 relative after:absolute after:bottom-[-4px] after:left-0 after:h-[2px] after:w-0 after:bg-accent-green after:transition-all after:duration-300 hover:after:w-full"
          >
            Menu
          </Link>
          <Link
            href="/cart"
            className="relative text-text-secondary hover:text-accent-gold transition-colors duration-300 after:absolute after:bottom-[-4px] after:left-0 after:h-[2px] after:w-0 after:bg-accent-green after:transition-all after:duration-300 hover:after:w-full"
          >
            Cart
            {totalItems > 0 && (
